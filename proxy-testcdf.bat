...
java %JAVA_AGENT% -DproxySet=true -Dhttp.proxyHost=127.0.0.1 -Dhttp.proxyPort=8888 -Dhttps.proxyHost=127.0.0.1 -Dhttps.proxyPort=8888 -Djavax.net.ssl.trustStore=FiddlerKeystore -Djavax.net.ssl.trustStorePassword=apples -cp %CLASSPATH% com.xml_project.morganaxproc3.XProcEngine -config="%~dp0/config/morgana.xml" %*