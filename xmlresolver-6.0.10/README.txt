...
This is org.xmlresolver:xmlresolver:6.0.10 
...
The jar files are in the ‘lib’ directory:
  ...
  xmlresolver-6.0.10.jar contains the library module
  xmlresolver-apps-6.0.10.jar contains a couple of example applications
